...
## Tooling
> Ferramental de uso para uso e domínio próprio
...
> Tecnologias e implementações para o desenvolvimento da interface da aplicação
...
> Tecnologias para implementação do código que gerencia toda a regra de negócio do lado do servidor.
...
> Bancos de Dados e outros ambientes de armazenamento de dados, de onde a aplicação toma uso e maniula.
